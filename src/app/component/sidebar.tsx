  ...
  return (
    <div className="h-screen flex flex-col justify-center items-center p-3">
      ...
      <div className="mt-3">
        <h2
          data-aos="fade-left"
          className="text-2xl text-center font-bold tracking-tight uppercase"
        >
          Muhammad Hammad Zubair
        </h2>
        <h2
          data-aos="fade-right"
          className="text-md text-center font-semibold tracking-tight text-gray-700"
        >
          Web Developer
        </h2>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="mt-4">
          <Link
            href="https://www.linkedin.com/in/muhammad-hammad-zubair-4046082ba/"
            target="_blank"
        ...
        <div className="mt-4">
          <Link
            href="https://github.com/MUHAMMAD-HAMMAD-ZUBAIR/again-hackaton"
            target="_blank"
        ...
        <div className="mt-4">
          <Link
            href="https://vercel.com/muhammad-hammad-zubairs-projects"
            target="_blank"
      ...
      <Link href={"/cv/cv.not.original.pdf"} className="mt-4" target="_blank">
        <Button data-aos="fade-up">
          <FaDownload data-aos="fade-up" className="mr-2 h-4 w-4" />
          Download CV
        </Button>
      </Link>
    </div>
